...
<body class="theme-body min-h-screen overflow-x-hidden text-slate-900" data-loading-text="{{ __('ui.common.processing') }}">
    <div class="site-grid flex min-h-screen w-full flex-col overflow-x-hidden">
        <div class="theme-backdrop pointer-events-none absolute inset-x-0 top-0 -z-10 h-[38rem] overflow-hidden">
            ...
            <div class="theme-backdrop-image absolute inset-0 bg-cover bg-center opacity-20" style="background-image:url('{{ \Illuminate\Support\Facades\Vite::asset('resources/images/bg.jpg') }}')"></div>
            <div class="theme-backdrop-fade absolute inset-x-0 bottom-0 h-40 bg-gradient-to-b from-transparent to-[#f3f6f6]"></div>
        </div>
